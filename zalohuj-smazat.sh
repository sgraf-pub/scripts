...
# Backup
rsync --archive --verbose --executability --one-file-system --delete /media/DATA_n1/ /media/BACKUP_n1/
rsync --archive --verbose --executability --one-file-system --delete /media/DATA_n2/ /media/BACKUP_n2/
